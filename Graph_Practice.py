...
class Graph(object):
    ...
    def get_edge_list(self):
        ...
        for edge in self.edges:
            tripl = (edge.value, edge.node_from.value, edge.node_to.value)
            triples_list.append(tripl)
        return triples_list
        ...
        for node in self.nodes:
            ...
            for edge in node.edges:
                if edge.node_to.value != node.value:
                    ...
                    node_edge_list.append(tupl)
                else:
                    pass
            if node_edge_list == []:
                node_edge_list = None
            #print('node_edge_list '+ str(node_edge_list) )
            adjacency_list.append(node_edge_list)
